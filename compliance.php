...
<section>
  ...
  <article class="card">
    <a class="button" href="?week_start=<?= htmlspecialchars($week['start'], ENT_QUOTES, 'UTF-8') ?>&severity=all">All</a>
    <a class="button" href="?week_start=<?= htmlspecialchars($week['start'], ENT_QUOTES, 'UTF-8') ?>&severity=block">Only Blockers</a>
    <a class="button" href="?week_start=<?= htmlspecialchars($week['start'], ENT_QUOTES, 'UTF-8') ?>&severity=warn">Only Warnings</a>
  </article>
